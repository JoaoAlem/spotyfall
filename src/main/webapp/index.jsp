...
<body>
<!-- Container página -->
<div id="main" class="flex flex-col h-screen max-h-screen max-w-screen bg-padrao box-border">
        ...
        <nav class="navbar-nav flex flex-col w-40 h-full bg-sidebar overflow-y-auto basis-auto shrink-0">
            ...
            <div class="my-auto w-40">
                ...
                <div class="flex flex-col m-auto items-center max-h-24 overflow-y-auto overflow-x-visible space-x-3 max-w-32">
                    <a class="flex m-auto items-center space-x-3 w-24"  >
                        <i class="fa-solid fa-headphones h-4" :style="{color: iconsColor}"></i>
                        <p class="text-white text-md">Playlist 1</p>
                    </a>
                    <a class="flex m-auto items-center space-x-3 w-28"  >
                        <i class="fa-solid fa-headphones h-4" :style="{color: iconsColor}"></i>
                        <p class="text-white text-md">Playlist 2</p>
                    </a>
                    <a class="flex m-auto items-center space-x-3 w-28"  >
                        <i class="fa-solid fa-headphones h-4" :style="{color: iconsColor}"></i>
                        <p class="text-white text-md">Playlist 3</p>
                    </a>
                    <a class="flex m-auto items-center space-x-3 w-28"  >
                        <i class="fa-solid fa-plus h-4" :style="{color: iconsColor}"></i>
                        <p class="text-white text-md">Adicionar playlist</p>
                    </a>
                </div>
            </div>
            ...
            <div class="mt-auto mb-28 md:mb-16 w-40">
                <!-- Login -->
                <router-link v-if="usuario?.id" to="/usuario" class="flex m-auto items-center space-x-3 w-28" >
                    <i class="fa-solid fa-user h-6" :style="{color: iconsColor}"></i>
                    <p class="text-white text-xl">{{usuario.name}}</p>
                </router-link>
                <a v-else href="${pageContext.request.contextPath}/signin.jsp" class="flex m-auto items-center space-x-3 w-28" >
                    <i class="fa-solid fa-user h-6" :style="{color: iconsColor}"></i>
